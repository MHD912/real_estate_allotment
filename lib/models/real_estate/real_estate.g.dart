...
void _realEstateSerialize(
  ...
  writer.writeInt(offsets[1], object.realEstateId);
}
...
RealEstate _realEstateDeserialize(
  ...
  final object = RealEstate(
    price: reader.readLong(offsets[0]),
    realEstateId: reader.readInt(offsets[1]),
  );
  object.id = id;
  return object;
}
...
extension RealEstateQueryFilter
  ...
  QueryBuilder<RealEstate, RealEstate, QAfterFilterCondition>
      realEstateIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'realEstateId',
        value: value,
      ));
    });
  }
...
extension RealEstateQuerySortBy
  ...
  QueryBuilder<RealEstate, RealEstate, QAfterSortBy> sortByRealEstateId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'realEstateId', Sort.asc);
    });
  }

  QueryBuilder<RealEstate, RealEstate, QAfterSortBy> sortByRealEstateIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'realEstateId', Sort.desc);
    });
  }
}
...
extension RealEstateQuerySortThenBy
  ...
  QueryBuilder<RealEstate, RealEstate, QAfterSortBy> thenByRealEstateId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'realEstateId', Sort.asc);
    });
  }

  QueryBuilder<RealEstate, RealEstate, QAfterSortBy> thenByRealEstateIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'realEstateId', Sort.desc);
    });
  }
...
extension RealEstateQueryWhereDistinct
  ...
  QueryBuilder<RealEstate, RealEstate, QDistinct> distinctByRealEstateId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'realEstateId');
    });
  }
}
...
extension RealEstateQueryProperty
  ...
  QueryBuilder<RealEstate, int, QQueryOperations> priceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'price');
    });
  }

  QueryBuilder<RealEstate, int, QQueryOperations> realEstateIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'realEstateId');
    });
  }
}
