...
extension StakeholderByIndex on IsarCollection<Stakeholder> {
  Future<Stakeholder?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  Stakeholder? getByNameSync(String name) {
  ...
  Future<List<Stakeholder?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<Stakeholder?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(Stakeholder object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(Stakeholder object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<Stakeholder> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<Stakeholder> objects,
      {bool saveLinks = true}) {
...
extension StakeholderQueryWhere
  ...
  QueryBuilder<Stakeholder, Stakeholder, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Stakeholder, Stakeholder, QAfterWhereClause> nameNotEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
