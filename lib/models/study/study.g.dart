...
extension GetStudyCollection on Isar {
  IsarCollection<Study> get studies => this.collection();
}
...
extension StudyQueryFilter on QueryBuilder<Study, Study, QFilterCondition> {
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleEqualTo(
    String value, {
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'title',
        value: '',
  ...
  QueryBuilder<Study, Study, QAfterFilterCondition> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'title',
        value: '',
...
extension StudyQuerySortBy on QueryBuilder<Study, Study, QSortBy> {
  ...
  QueryBuilder<Study, Study, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Study, Study, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension StudyQuerySortThenBy on QueryBuilder<Study, Study, QSortThenBy> {
  ...
  QueryBuilder<Study, Study, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<Study, Study, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension StudyQueryWhereDistinct on QueryBuilder<Study, Study, QDistinct> {
  ...
  QueryBuilder<Study, Study, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension StudyQueryProperty on QueryBuilder<Study, Study, QQueryProperty> {
  ...
  QueryBuilder<Study, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
