...
import 'package:real_estate_allotment/views/find_lot_view/widgets/lot_item_widget.dart';
import 'package:real_estate_allotment/views/find_lot_view/widgets/lot_view_labeled_text_field.dart';

class FindLotView extends StatelessWidget {
  final ChooseLotController _controller;
  FindLotView({super.key}) : _controller = Get.find<ChooseLotController>();
