...
class ExcelMultiRealEstate extends Excel {
  ...
  Future<void> migrateDataToSheet() async {
    try {
      ...
      if (propertyList.length == 1) {
        return await _generateStudy(propertyList.first);
      } else {
  ...
  Future<void> _generateStudy(RealEstate property) async {
    int currentRow = 3;
