...
import 'package:real_estate_allotment/views/allotments/lot_allotment/find_shareholder_allotment_view/find_shareholder_allotment_view.dart';
...
class AllotmentRoutes {
  static List<GetPage> pages = [
    ...
    GetPage(
      name: AppRoutes.findShareholderAllotment,
      page: () => FindShareholderAllotmentView(),
      bindings: [
        FindAnimationControllerBinding(),
        FindShareholderAllotmentBindings(),
      ],
    ),
    GetPage(
